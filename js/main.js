...
AM.addMusic("./sound/menu/game_music.mp3");
AM.addMusic("./sound/menu/achievement.mp3");
...
AM.queueDownload("./img/background/game_tutorial_screen.png");
AM.queueDownload("./img/background/pause_screen.png");
...
AM.downloadAll(function () {
	...
	soundArr[MENU_MUSIC] = AM.getMusic("./sound/menu/menu_music.mp3");
	...
	soundArr[GAME_MUSIC] = AM.getMusic("./sound/menu/game_music.mp3")
	...
	animArr[BACKGROUND_GAMEPAUSE] = AM.getAsset("./img/background/pause_screen.png");
	animArr[BACKGROUND_GAMETUTORIAL] = AM.getAsset("./img/background/game_tutorial_screen.png");
    ...
    gameEngine.init(ctx);
    gameEngine.addBackground(new Background(gameEngine, animArr[BACKGROUND_FOREST], GAMESIZE_X, GAMESIZE_Y));
    gameEngine.addBackground(new Background(gameEngine, animArr[BACKGROUND_BLIZZARD], GAMESIZE_X, GAMESIZE_Y));
    gameEngine.addBackground(new Background(gameEngine, animArr[BACKGROUND_VOCANO], GAMESIZE_X, GAMESIZE_Y));
    gameEngine.addBackground(new Background(gameEngine, animArr[BACKGROUND_GAMEOVER], GAMESIZE_X, GAMESIZE_Y));
    gameEngine.addBackground(new Background(gameEngine, animArr[BACKGROUND_GAMESTART], GAMESIZE_X, GAMESIZE_Y));
    gameEngine.addBackground(new Background(gameEngine, animArr[BACKGROUND_GAMEPAUSE], GAMESIZE_X, GAMESIZE_Y));
    gameEngine.addBackground(new Background(gameEngine, animArr[BACKGROUND_GAMETUTORIAL], GAMESIZE_X, GAMESIZE_Y));
    gameEngine.start();
